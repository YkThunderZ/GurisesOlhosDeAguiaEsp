...
local function createVisualForCharacter(character, player)
    ...
    healthLabel.Position = UDim2.new(0, 0, 0.96, 0)
...
local main = create("Frame", {
    ...
    Position = UDim2.new(0.9, -Config.WindowSize.X.Offset/7, 0.9, -Config.WindowSize.Y.Offset/7),
...
title.Text = "Gurizes Olho de Aguia"
...
homeTitle.Text = "E US GURI OLHOS DE AGUIA"
...
homeDesc.Text = "Created by: ???, Modificado por: YkThunder\n Se tu tomar ban, problema e teu!"
...
do
    ...
    y = y + 48
    makeSlider(espPage, y, "Max Range (studs)", 50, 10000, State.ESP.Range, function(v) 
